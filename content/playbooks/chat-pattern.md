...
- [[playbooks/generative-interface|生成式界面]] — Chat 界面本身虽然是固定的，但可以搭配生成式的内容呈现
- [[playbooks/copilot-pattern|Copilot 范式]] — Chat 可以搭配 Copilot 的辅助建议模式
- [[角色锁定|角色锁定]] — Chat 可以用特定角色来提升用户粘性
