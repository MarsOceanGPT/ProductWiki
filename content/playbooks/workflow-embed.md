...
### [[产品卡片-Slack|Slack]]
Slack 的护城河很大程度上来自工作流嵌入。企业的通讯、协作、文件共享、集成都在 Slack 上。迁移到竞品（比如 Teams），不仅要迁移数据，还要重新建立"所有的工作流程"。这个成本是巨大的。

### [[产品卡片-Figma|Figma]]
设计师已经在 Figma 上完成了整个设计流程：探索、原型、协作、交付。迁移到竞品意味着要重新学习、重新适应新工具的逻辑。这个适应成本通常超过"功能差异"的价值。
...
- [[playbooks/social-stickiness|社交粘性]] — 工作流粘性是功能粘性，社交粘性是情感粘性，两者结合最强
- [[playbooks/data-flywheel|数据飞轮]] — 用户在产品上积累的数据，进一步强化了工作流嵌入
