...
founders:
  - Peter Duris
  - Tomas Ondrejka
stage: Active (Private)
status: Growing
metrics_date: 2026-03
arr: $1.9M+
users: 5M+ job seekers helped / 8K paying customers
monthly_visits: 2M+
mau: 1M+
funding_total: €2M+ (Credo Ventures led round)
funding_rounds:
  - Seed/Angel funding (Credo Ventures, Vision Ventures, CEED Tech, VentureOut)
...
pricing_model:
  ...
  - Business/Employer plans (variable)
opportunity_playbooks:
  - Vertical AI specialization (resumes only, done extremely well)
  - ATS optimization as core differentiator
  - International arbitrage (Slovakia costs vs global market)
  - B2B job board expansion for employers
  - Personal AI agents for candidates & companies
design_playbooks:
  - 40+ ATS-optimized resume templates by HR experts
  - GPT-4 AI Resume Writer from job title alone
  - Drag-and-drop editor for simplicity
  - Personal website generation with single click
  - Resume tailoring from job descriptions
mvp_playbooks:
  - Resume template library + simple editor
  - Basic AI content generation for bullet points
  - Export to PDF/online link
  - Free tier with limitations
pmf_playbooks:
  - International job seekers avoiding language barriers
  - Non-native English speakers optimizing expression
  - Job seekers optimizing for ATS systems (growing pain point)
  - Employers finding pre-screened candidates through platform
growth_playbooks:
  - SEO optimization for "resume builder" keywords
  - Content marketing on job search and career topics
  - Freemium viral loop with limited free tier
  - International expansion (23+ language support)
  - Job board integration for employer acquisition
monetization_playbooks:
  - Freemium resume builder with premium template access
  - Subscription tiers for unlimited AI generations
  - Business plans for employers/HR teams
  - Job board listings from employers (B2B revenue)
  - Potential personal AI agent premium tier
moat_playbooks:
  - ATS optimization expertise and algorithm
  - Large database of 5M+ job seeker profiles
  - Trusted brand in European resume builder market
  - Integration of resume data with job board
  - GPT-4 integration for content quality
distance_to_money: Direct (B2C subscription + B2B employer plans)
industry_layer: Application/Career & Recruitment Tools
pricing_quadrant: Freemium with premium upsell ($8-24/month for individuals)
key_people:
  - Peter Duris (Co-founder & CEO)
  - Tomas Ondrejka (Co-founder & CMO)
competitors:
  - Resume.io (comprehensive career toolkit)
  - Rezi (AI resume optimization)
  - Resumelab (templates + AI features)
  - Resumemaker (simple free alternative)
  - LinkedIn (free resume feature)
  - ChatGPT (generic content generation)
related_products:
...
- 想了解竞品？看 [[产品/Resume.io|Resume.io]]、[[产品/Rezi|Rezi]]、[[产品/Resumelab|Resumelab]]
...
- **LinkedIn已有Resume功能**但质量基础、模板有限
- **传统模板库** (Canva、Microsoft Word) 无法处理ATS优化问题
- **全球500M+求职者**中，50%的简历无法通过ATS系统扫描
...
**我的判断**：Kickresume最可能的路是**方案C（被收购）**，在2026-2027年内。
...
**融资与公司信息**：
- [Kickresume在Crunchbase的资料](https://www.crunchbase.com/organization/kickresume)
- [Kickresume在Tracxn的公司档案](https://tracxn.com/d/companies/kickresume/)
- [2024年营收$1.9M的详细分析 - Latka](https://getlatka.com/companies/kickresume)

**创始人与团队**：
- [Peter Duris (CEO) LinkedIn Profile](https://sk.linkedin.com/in/peterduris)
- [Tomas Ondrejka (CMO) 在Kickresume的作者页面](https://www.kickresume.com/en/help-center/authors/tomas-ondrejka/)

**产品与功能**：
- [Kickresume ATS优化技术评测 - PitchMeAI](https://pitchmeai.com/blog/kickresume-ats-optimization-review)
- [ATS Resume Checker工具 - Kickresume官方](https://www.kickresume.com/en/ats-resume-checker/)
- [ATS友好型简历指南 - Kickresume Blog](https://www.kickresume.com/en/blog/ats-friendly-resume/)
- [从职位描述AI生成简历工具](https://www.kickresume.com/en/ai-resume-from-job-description/)

**竞争分析**：
- [Kickresume vs Resumake对比 - SaaSHub](https://www.saashub.com/compare-kickresume-vs-resumake)
- [Kickresume vs ResumeBuilder.com对比 - ResGen](https://www.tryresgen.com/blogs/kickresume-vs-resumebuildercom)
- [Kickresume备选工具对比 - AlternativeTo](https://alternativeto.net/software/kickresume/)
- [Rezi vs Kickresume的AI简历构建器对比 - Rezi官方](https://www.rezi.ai/posts/kickresume-alternative)

**用户评价与案例**：
- [Kickresume定价与功能对比 - Capterra](https://www.capterra.com/p/180489/Kickresume-for-Business/)
- [Kickresume 2026评测：是炒作还是真实解决方案 - 4DayWeek](https://4dayweek.io/blog/kickresume-review)
