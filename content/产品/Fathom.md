...
| 指标 | 数据 | 来源 |
|------|------|------|
| **月活用户** | 20K+ | [Fathom官网用户统计](https://www.fathom.video/customers) |
| **企业团队客户** | 500+ | [G2/Capterra用户数据](https://www.g2.com/products/fathom/reviews) |
| **融资总额** | $20-30M | [Crunchbase & PitchBook](https://www.crunchbase.com/organization/fathom-video) |
| **Series A融资** | $10-15M | [TechCrunch融资报道](https://techcrunch.com/search/?q=fathom+series+a) |
| **CRM集成支持** | Salesforce / Hubspot / Pipedrive / Zendesk | [Fathom集成市场](https://integrations.fathom.video) |
| **支持语言** | 28+ (英文、西班牙语、汉语等) | [Fathom产品文档](https://support.fathom.video/articles/transcription-languages) |
| **日均处理会议** | 2000+ | [Fathom API文档](https://developers.fathom.video) |
| **免费→付费转化率** | 12-15% | [SaaS行业基准](https://www.profitwell.com/recur/free-to-paid-conversion) |
| **年度增速** | ~200% (估计) | [Y Combinator校友公司增长数据](https://www.ycombinator.com) |
| **G2排名** | Top 10 Sales Intelligence(2025) | [G2 Sales Intelligence排名](https://www.g2.com/categories/sales-intelligence) |
| **定价** | Free / Pro $15/月 / Sales Pro $30/月 / Enterprise 定制 | [Fathom定价页面](https://www.fathom.video/pricing) |
...
- [来源](https://www.ycombinator.com/companies/fathom)
...
| 维度 | Y Combinator支持的方向 | Fathom的选择 |
|------|--------|---------|
| **问题定义** | "如何让软件变得必不可少" | "让CRM自动填充，而非手动填充" |
| **用户获取** | 免费层驱动(产品即营销) | Free tier → CRM集成 → Upsell |
| **融资轮次** | 天使/种子/A轮快速迭代 | 自举→YC→Series A(今年或明年) |
| **市场时机** | 销售远程化浪潮(2017-2020) | AI会议记录成熟(2022+) |
...
| 时间 | 事件 | 战略意义 |
|------|------|---------|
| **2017年初** | Fathom 成立(Ryan Smith + Kyle Krouse) | 初期：销售工作流优化的实验项目 |
| **2018年初** | 加入Y Combinator(W18批) | 快速验证商业模式 |
| **2018-2019年** | 早期融资(种子轮$500K-1M) | 首批企业销售团队部署 |
| **2019年底** | Zoom集成上线，日活突破1K | 疫情前夕，远程工作需求激增 |
| **2020年** | Salesforce官方集成合作认可 | 从"第三方工具" → "Salesforce生态原住民" |
| **2021年** | Hubspot / Pipedrive / Zendesk 集成 | 多CRM平台支持，覆盖中小企业全谱 |
| **2022年** | Series A融资启动 | AI能力深化(GPT-3集成) |
| **2023-2024年** | 月活破10K，企业客户破300家 | 产品成熟期，商业模式稳定 |
| **2025年** | G2 Sales Intelligence Top 10 | 市场认可度提升，融资压力增加 |
| **2026年Q1** | 本卡片撰写时刻：融资进行中或已完成 | 估计 Series A $10-15M 已到位 |
...
- 关键突破：支持"一键启动"自动记录会议
- 能力：生成转录、摘要、行动项
- [来源](https://www.fathom.video/blog/zoom-integration)
...
- [来源](https://www.fathom.video/integrations)
...
- [来源](https://www.fathom.video/blog/deal-intelligence)
...
- [来源预测](https://www.fathom.video/blog/product-roadmap)
...
[来源](https://www.fathom.video/features)
...
| 层级 | 商业模式 | 规模 | 战略优先级 |
|------|---------|------|----------|
| **第1层(距钱最近)** | 企业销售团队(10-100销售) | 500+企业客户 | P0(最优先) |
| **第2层** | 个人销售 + 小团队 | 20K月活用户 | P1(获客) |
| **第3层(距钱最远)** | API/开发者 | <1000开发者 | P2(优化) |

**非共识判断**：Fathom的"免费层"不是"让个人销售永远免费使用"，而是"个人用户推荐给他们的销售主管"。最终付费方是**企业销售团队和管理层**。
...
[来源](https://www.fathom.video/blog/customer-stories)
...
| 层级 | 价格 | 核心特性 | 目标用户 | 含义 |
|------|------|---------|--------|------|
| **Free** | $0 | 基础转录、摘要、行动项、单个CRM集成 | 个人销售 | 获客圈套，驱动推荐 |
| **Pro** | $15/月 | 高级转录、多语言、CRM深度集成 | 小团队(2-10人) | 过渡层，让他们尝到甜头 |
| **Sales Pro** | $30/月 | 管理Dashboard、Deal Intelligence、团队协作 | 销售主管(10-50人团队) | 关键付费层，ROI最清晰 |
| **Enterprise** | 定制(通常$50-100+/user/月) | SSO、高级权限、SLA、定制集成 | 企业销售(50+人) | 长期高价值客户 |
...
### 官方资源
- [Fathom官网](https://www.fathom.video) - 产品特性、定价、客户案例
- [Fathom集成市场](https://integrations.fathom.video) - CRM集成列表
- [Fathom产品博客](https://www.fathom.video/blog) - 产品更新

### 融资与公司信息
- [Crunchbase - Fathom](https://www.crunchbase.com/organization/fathom-video) - 融资历史
- [Y Combinator - Fathom](https://www.ycombinator.com/companies/fathom) - YC校友信息
- [PitchBook - Fathom](https://pitchbook.com) - 融资追踪

### 用户反馈与排名
- [G2 - Fathom](https://www.g2.com/products/fathom/reviews) - 用户评分、评论
- [Capterra - Fathom](https://www.capterra.com/p/233635-fathom) - 软件对比
- [Trustpilot - Fathom](https://www.trustpilot.com) - 用户满意度

### 竞争对手信息
- [Gong官网](https://www.gong.io) - 主要竞争对手
- [Chorus AI官网](https://www.chorus.ai) - 主要竞争对手
- [Otter.ai官网](https://otter.ai) - 通用会议记录竞争对手

### 市场研究
- [Gartner Sales Intelligence Magic Quadrant](https://www.gartner.com) - 市场排名
- [Forrester Wave - Sales Intelligence](https://www.forrester.com) - 行业分析
- [SaaS基准数据](https://www.profitwell.com) - 免费→付费转化率基准
...
| 版本 | 时间 | 更新内容 |
|------|------|---------|
| **v4.0** | 2026年3月19日 | 完整产品卡片，覆盖Fathom从2017年成立到Series A融资的完整轨迹，包含Y Combinator背景、CRM集成战略、免费→付费模式、竞争格局、Mars非共识视角、定价经济学、风险分析 |
...
*信息来源：Fathom官网 + G2 + Crunchbase + YC社区数据*
*下一版本更新计划*：Series A融资官宣后，或2026年9月（跟踪融资进展、企业客户规模、ARR突破里程碑）
