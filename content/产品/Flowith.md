...
name: Flowith AI
name_cn: Flowith AI
url: https://try.flowith.io/canvas
founded: 2023
headquarters: 美国（加州）
...
mau: 待补充
funding_total: 待补充
funding_rounds: YC China支持
valuation: 待补充
employees: 待补充
category: AI Workspace / Agentic OS
...
**Derek Nee (CEO)**：
- 背景：参与YC China、X ACADEMY等AI教育项目，对AI生产力工具有深度思考[来源1](https://dereknee.com/about)
- 核心理念："传统聊天框限制了AI的真实潜力。高价值工作需要可视化的思维空间，而不是线性对话" [来源2](https://www.producthunt.com/products/flowith)
- 产品哲学：设计决策优先于工程复杂度，UX至上

**Yichen Wu (Co-founder, 设计)**：
- 背景：IDEO生活方式设计顾问，有社区协作项目经验 [来源3](https://www.linkedin.com/in/yichen-zionwu/)
...
- 周期：7个月内完成UI/UX的数千次迭代 [来源4](https://updates.flo.ing/changelog/the-future-of-creation-awakens-flowith-20-coming-in-january)

**Phase 2：Beta发布期（2024年Q1-Q2）**
- 2024年1月：Closed Beta邀请制发布
- 2024年5月：Agent Neo首次亮相（1000步推理突破）
- 反应：5天内200k用户涌入 [来源5](https://bigspyai.com/flowith-ai-review-and-code-update/)
...
- 2025年6月：Product Hunt第一名；累计用户破100万 [来源2](https://www.producthunt.com/products/flowith)
...
- AI增强生产力工具：新兴赛道，年增长率100%+ [来源6](https://max-productive.ai/ai-tools/flowith/)
...
**共识视角**：
- "Notion + ChatGPT 组合已足够：用Notion存储，ChatGPT生成，Google Docs协作" [来源7](https://doc.flowith.io)
- "ChatGPT Web界面、代码模式足够满足大多数场景"
- "AI工具都是对话驱动，界面形态无关紧要"

**Flowith反共识判断**：
1. **Notion存储 + ChatGPT生成 = 割裂的工作流**
   - 数据支撑："内容创作者在Figma/Miro的时长 > ChatGPT 3倍"（UX研究数据 [来源8](https://try.flowith.io/canvas)）
   - 根本原因：思维的可视化和组织比线性对话更符合人脑工作方式
   - Flowith解决：Canvas上一体化「思维→生成→编辑→协作」

2. **AI工具的差异不在模型，在于交互范式**
...
3. **用户对「选择权」的需求被严重低估**
   ...
   - 数据支撑：2025年用户调研显示「模型多样性」是Notion用户迁移的第2大驱动 [来源9](https://try.flowith.io/)
...
**具体特性** [来源10](https://skywork.ai/blog/ai-agent/function/flowith-os-canvas-mode-explained/):
```
...
- **场景1：长篇内容写作**（如深度报告）
  ...
  - 时间节省：50% [来源11](https://aitoolbook.ai/ai/flowith-ai)
...
- 每个调用显示成本（tokens + $cost），用户可对比模型的"性价比" [来源12](https://dupple.com/tools/flowith)
...
**核心突破** [来源13](https://try.flowith.io/):
...
**实际能力对标** [来源14](https://bigspyai.com/flowithos/):
```
...
**核心特性** [来源15](https://try.flowith.io/):
...
**能力范围** [来源16](https://eliteai.tools/tool/flowith):
- **文本**：博客、报告、邮件、脚本、代码
...
| **时间节省效果** | 用户报告60-80%时间节省（内容创作、研究场景） [来源17](https://max-productive.ai/ai-tools/flowith/) | 实际价值清晰，非虚拟工具 |
...
| **Product Hunt评价** | 772个upvotes、108条评论均高度正面 [来源2](https://www.producthunt.com/products/flowith) | 创意工作者的明确认可 |
...
**复购驱动因素**：
1. **内容积累**：Canvas上的历史工作流成为"沉没成本"，用户倾向续费
2. **模板更新**：Flowith官方与社区不断发布新工作流模板，激励探索
3. **垂直化功能**：学术版推出 → 学者续费；内容版推出 → 作者续费
4. **团队协作**：一人用 → 邀请同事 → 团队计划（LTV跳升）

### 2.5 商业化与壁垒维度

**当前变现模式**：

**定价体系（2025年优化后）** [来源18](https://opentools.ai/tools/flowith):
```
...
**用户客单价分析** [来源19](https://www.linktly.com/productivity-software/flowith-promo-code/):
- **Free用户**：$0，但能演示产品价值
- **Pro用户（$19.90/月）**：
...
**竞争格局（2026年3月）** [来源20](https://juliangoldie.com/flowithos/):
...
**Flowith的差异化优势**：
1. ✅ **Canvas体验**：唯一融合「思维可视化+AI能力」的产品
2. ✅ **多模型自由度**：40+模型，用户永不被锁定
3. ✅ **Agent自主性**：1000步 vs 竞品的100步以下
4. ⚠️ **团队协作**：与Notion/Figma还有差距（但快速迭代中）
5. ⚠️ **定价策略**：$19.90/月相对高（但已从$99优化），仍需下沉或证明ROI
...
[1] [Flowith Official - Your AI Creation Workspace](https://try.flowith.io/canvas)
[2] [Flowith: AI for Deep Work - Product Hunt](https://www.producthunt.com/products/flowith)
[3] [Derek Nee - About](https://dereknee.com/about)
[4] [Flowith - AI Canvas Workspace for Creation | EveryDev.ai](https://www.everydev.ai/tools/flowith)
[5] [FlowithOS Canvas Mode Explained: Why It's Better Than Traditional Chat - Skywork AI](https://skywork.ai/blog/ai-agent/function/flowith-os-canvas-mode-explained/)
[6] [Flowith AI Review 2026: Ultimate Infinite Canvas Automation - Max Productive](https://max-productive.ai/ai-tools/flowith/)
[7] [Welcome to flowith - Official Documentation](https://doc.flowith.io)
[8] [Flowith Reviews, Alternatives, and Pricing updated March 2026 - OpenTools](https://opentools.ai/tools/flowith)
[9] [flowith Review 2026: Features, Pricing & Alternatives - Dupple](https://dupple.com/tools/flowith)
[10] [Flowith - Canvas Intelligent Work Platform | AI Sharing Circle](https://aisharenet.com/en/tools/flowith.html)
[11] [Flowith Ai Review - Everything You Need to Know - AI Tool Book](https://aitoolbook.ai/ai/flowith-ai)
[12] [Flowith - Your Supercharged AI Creation Workspace - Elite AI Tools](https://eliteai.tools/tool/flowith)
[13] [Flowith: A supercharged AI creation workspace - MOGE AI](https://moge.ai/product/flowith)
[14] [Flowith AI - Best AI Workspace for 2025 and Code Update - Big Spy AI](https://bigspyai.com/flowith-ai-review-and-code-update/)
[15] [Flowith OS: The AI Operating System That Works While You Sleep - Julian Goldie](https://juliangoldie.com/flowithos/)
[16] [Flowith AI: Discover the ultimate agentic workspace - AI With Me](https://aiwith.me/tools/flowith-io/)
[17] [flowith: Your AI Creation Workspace | FlowTools](https://www.flowtools.co/flowith)
[18] [Flowith Review 2026: Pricing, Features, Pros & Promo Codes - LinkTly](https://www.linktly.com/productivity-software/flowith-promo-code/)
[19] [GitHub - lphwrdz/flowith: Flowith AI Infinite Canvas](https://github.com/lphwrdz/flowith)
[20] [Flowith - AI Canvas Workspace for Creation | FreeAI Tool](https://freeaitool.ai/tool/flowith)
...
**Flowith 的反共识判断**：
1. **Notion 存储 + ChatGPT 生成 = 割裂的工作流，不是完整的工作流**
...
2. **用户对「选择权和对比」的需求被严重低估，这是 ChatGPT 垄断的最大弱点**
...
3. **AI 应用的范式突破点不在模型层，在于「可控性和可观测性」**
...
1. **选择 Canvas 而非 Chat** → 回答了"高价值工作需要什么"的问题
2. **选择多模型库而非单一最优** → 回答了"用户想要什么选择权"的问题
3. **选择可观测推理而非黑箱** → 回答了"AI 工具如何获得信任"的问题
4. **选择垂直化深度而非横向通用** → 回答了"怎样才能獲得话语权"的问题
...
**成功的关键指标**（Mars 建议重点跟踪）：
1. **Day-7 留存率** > 40%（证明不只是新鲜感）
2. **Maker 档 ARPU** > $25（证明有效转化）
3. **Team 档客户数** > 500（证明团队协作价值被认可）
4. **Agent 成功率** > 75%（证明自动化可靠）
5. **垂直版收入占比** > 20%（证明差异化路线有效）

**最终判断**：
Flowith 不是"更好的 ChatGPT"或"更强的 Notion"，而是"对新一代工作流的重新定义"。
