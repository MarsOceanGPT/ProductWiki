...
related_products:
  ...
  - '[[01-产品库/Canva|Canva]]'
  - '[[01-产品库/Adobe Lightroom|Adobe Lightroom]]'
  - '[[Shopify]]'
  - '[[Etsy]]'
...
- **为什么他能看到这个opportunity**：
  1. Apple背景给了他"Vision算法"的深度knowledge
  2. 他自己可能有electrically business朋友，了解pain point
  3. 时机对：2019年CNN/U-Net算法已经mature enough
...
1. **E-commerce sellers的enthusiastic adoption**
...
1. **背景移除AI质量** → Apple工程师+years of training
2. **电商平台integration** → Shopify, Amazon, Etsy等深度集成
3. **电商workflow理解** → 产品为e-commerce而非generic
4. **团队技术基因** → Apple背景确保quality
5. **用户网络** → 20M users提供training data
...
vs Remove.bg: Generic background removal API
vs Photoroom: Focus on e-commerce specifics
...
Photoroom没有说"我们will go direct sales"。
而是"我们will integrate into Shopify, Amazon等"。
...
Remove.bg可能有equally good背景移除AI。
但Photoroom focus on e-commerce specifics让他们win。

启示：**narrow + deep通常beat broad + shallow**。

**启示2：Platform integration是underrated的distribution channel**

很多startup focus on paid ads。
Photoroom focus on being great in app stores。

启示：**if relevant platform exist，深度集成often beat broad marketing**。

**启示3：Apple背景不总是必须，但能确保quality**

Matthieu的Apple经验让他know"什么是production-quality AI"。
这给了Photoroom credibility。
...
理由：
1. 专业摄影师提供的是：好的lighting + composition + background选择
2. Photoroom提供的是：从已有photo remove background
3. 这两者不同（一个是creation，一个是post-processing）
...
Photoroom的故事有意思因为它demonstrate了**domain specialization的力量**。

Matthieu从Apple看到：背景移除算法已经ready。但他没有选择"build generic background removal"。而是选择"build background removal for e-commerce"。

这个选择的implications：
1. 产品设计围绕e-commerce workflow优化（batch processing, platform integration等）
2. 销售方向清晰（SMB e-commerce sellers）
3. 竞争更可控（vs generic Remove.bg）
