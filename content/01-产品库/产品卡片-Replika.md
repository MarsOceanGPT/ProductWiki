...
founders:
  - Eugenia Kuyda
stage: Profitable (no recent external funding)
status: Active (Limited by regulation in some regions)
metrics_date: 2026-03
arr: ~$14M
users: 3-4M monthly active
monthly_visits: Information not available
mau: 3M (estimated)
funding_total: $11M
funding_rounds:
  - 'Series A $6.5M (Khosla Ventures, 2017)'
valuation: '$10-50M (estimated, 2017 valuation)'
employees: ~93
category: AI Companion / Chatbot
subcategory: 'Emotional AI, Personal Assistant Chatbot'
target_user: >-
  Lonely individuals, people seeking companionship, mental health support
  seekers
pricing_model:
  - Freemium
  - Subscription
opportunity_playbooks:
  - Emotional AI market expansion
  - Mental health regulation compliance
  - Monetizing personal attachment
design_playbooks:
  - Memory persistence
...
pmf_playbooks:
  ...
  - Different from Character.AI's multi-character model
growth_playbooks:
  - 'Niche adoption (lonely individuals, mental health seekers)'
  - Viral emotional stories
monetization_playbooks:
  - Subscription with premium features
  - Emotional dependency as retention driver
moat_playbooks:
  - Personal memory and relationship history
  - Emotional attachment over time
  - Regulatory protections
distance_to_money: Direct (B2C subscription)
industry_layer: Application/Social
pricing_quadrant: Premium subscription (emotional premium)
key_people:
  - 'Eugenia Kuyda (Founder, CEO)'
competitors:
  - Character.AI
  - Chai
  - CrushOn
...
**当前状态**（2025年）：
- ARR：~$14M（compared to early 2022的可能$20-30M）
- 用户量：相对stable，~3-4M MAU
- 盈利：推测positive（no burn rate）
- 市场认知：从"erotic companion"转向"mental health tool"，但reputation damage persist
...
- 2026-03-14 | 初稿完成，重点关注origin story、erotic feature scandal、regulatory crisis
- 分析了emotional attachment的double-edged sword nature
- 比较了vs Character.AI的strategic choice
- 待补充：具体的user data、mental health efficacy research、国际监管landscape detail

---

**信息补充**：
- ARR数据来自Latka，需要verify accuracy
- Mental health efficacy claims缺乏published research backing
- Eugenia Kuyda's current focus and新projects的信息limited
- Germany GEMA lawsuit的ongoing status and implications需持续追踪
- 与traditional therapy industry的collaboration potential unexplored
